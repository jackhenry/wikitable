...
setup(
    ...
    packages=['venv.Lib.site-packages.bs4', 'venv.Lib.site-packages.bs4.tests', 'venv.Lib.site-packages.bs4.builder',
              ...
              'venv.Lib.site-packages.pip-10.0.1-py3.7.egg.pip._internal.operations', 'venv.jack', 'venv.jack.henry'],
    url='www.github.com/jackhenry',
    license='GPL',
    author='Malone',
    author_email='jackhenry.tech@gmail.com',
    description='scrape tables from wikipedia article'
)
